...
public class NasirImanCupcakeSmash extends Applet implements ActionListener
{
	...
	JButton next = new JButton (createImageIcon ("images/instruct.png"));
	next.setBorderPainted (false);
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		a [move] = new JButton (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		b [move] = new JButton (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		c [move] = new JButton (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
	...
	for (int i = 0 ; i < row1 ; i++)
	{
	    ...
	    {
		d [move] = new JButton (createImageIcon ("images/" + colourD [i] [j] + "" + typeD [i] [j] + "r.png"));
	...
	JButton next = new JButton (createImageIcon ("images/instruct1.png"));
	next.setBorderPainted (false);
	...
	JButton next = new JButton (createImageIcon ("images/instruct2.png"));
	next.setBorderPainted (false);
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		a [m].setIcon (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
		m++;
	    }
	}
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		b [n].setIcon (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
		n++;
	    }
	}
	//updates moves and points
	...
	for (int i = 0 ; i < row ; i++)
	{
	    for (int j = 0 ; j < col ; j++)
	    {
		c [l].setIcon (createImageIcon ("images/" + colour [i] [j] + "" + type [i] [j] + "" + piece [i] [j] + ".png"));
		l++;
	    }
	}
	//updates moves and points
	...
	for (int i = 0 ; i < row1 ; i++)
	{
	    for (int j = 0 ; j < col1 ; j++)
	    {
		d [o].setIcon (createImageIcon ("images" + colourD [i] [j] + "" + typeD [i] [j] + "" + "r.png"));
		o++;
	    }
	}
	//updates moves and points
	...
	{
	    JOptionPane.showMessageDialog (null, createImageIcon ("images/vcr.png"), "Winner! Play again now!", JOptionPane.INFORMATION_MESSAGE);
	    reset ();
	}
    }
	...
	{
	    JOptionPane.showMessageDialog (null, createImageIcon ("images/ypr.png"), "Time is up! Play again now!", JOptionPane.INFORMATION_MESSAGE);
	    chooseTime ();
	    reset ();
	}
	...
	{
	    JOptionPane.showMessageDialog (null, createImageIcon ("images/phr.png"), "Winner! Play again now!", JOptionPane.INFORMATION_MESSAGE);
	    chooseTime ();
	    reset ();
	}
    }
	...
	if (checkCupcake ())
	{
	    JOptionPane.showMessageDialog (null, createImageIcon ("images/--c.png"), "You lose! Play Again!", JOptionPane.INFORMATION_MESSAGE);
	    reset ();
	}
	...
	{
	    JOptionPane.showMessageDialog (null, createImageIcon ("images/extinguisher.png"), "Winner! You set the fire out! Play again!", JOptionPane.INFORMATION_MESSAGE);
	    reset ();
	}
    }
